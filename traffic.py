...
def get_model():
    ...
    Assumes that the `input_shape` of the first layer is `(IMG_WIDTH, IMG_HEIGHT, 3)`.
    ...
    model.add(tf.keras.layers.Dropout(0.5))  # Optional dropout layer for regularization
